...
def set_custom_config(cfg):
    load_from = 'work_dirs/rtmdet_x_syncbn_fast_8xb32-300e_coco/best_coco_bbox_mAP_epoch_292.pth'
    # load_from = 'work_dirs/rtmdet_Norway_2560/epoch_190.pth'
    data_root = '/data2/wangfj/data/road_damage'
    ...
    cfg.train_dataloader.dataset.data_prefix.img = image_prefix

    cfg.val_dataloader.dataset.data_root = data_root
    cfg.val_dataloader.dataset.ann_file = val_ann_file
    cfg.val_dataloader.dataset.data_prefix.img = image_prefix
    
    cfg.default_hooks.checkpoint.save_best = 'auto'
    #cfg.pop('val_cfg', None)
    #cfg.pop('val_dataloader', None)
    #cfg.pop('val_evaluator', None)
